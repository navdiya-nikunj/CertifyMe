...
export default function GenerateCertificate (
    ...
    useEffect (() => {
        // certificateData();
        setCertificateData({certificateName: certificate.certificateName,certificateDesc: certificate.certificateDesc});
    }, []);
    ...
    const submit = async () => {
        ...
        // shows certificate - certificate page
    }
    ...
    return (
        <div>
            ...
            placeholder="Enter the name of the student" required/>
            <br/>
                <label>Student Wallet: </label>
                <input type="text" name="studenrWallet" value={formData.studenrWallet} onChange={handleChange}
                placeholder="Enter the wallet address of the student" required/>
                <br/>
